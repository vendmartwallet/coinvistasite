      ...
      <div>
        <div className="abtcomp min-w-full bg-[#062B1F] py-14">
          <div className="title flex flex-col pb-10">
            <div className=" text-[#E9D16F] font-semibold font text-3xl  text-center" data-aos="fade-down">
              ABOUT 10XSIGNAL
            </div>
          ...
          <div className="div1 grid grid-cols-1 lg:flex items-center justify-center gap-14 lg:h-[50vh] mx-auto">
            <div className=" h-[45vh] lg:w-[35%]" data-aos="flip-left">
              <iframe
                height="100%"
                width="100%"
            ...
            <div className="px-5 lg:w-[40%] flex flex-col justify-center items-center text-white text-2xl font-light" data-aos="fade-down">
          ...
          <div className="div1 mt-10 lg:flex items-center justify-center gap-14 h-lg:[50vh] mx-5 lg:mx-auto">
            <div className="px-5 lg:w-[40%] flex flex-col justify-center items-center text-white text-2xl font-light" data-aos="fade-up">
              <span className="pb-2 text-[#E9D16F] font-semibold italic text-3xl">
                Denna Lewis
              </span>{" "}
            ...
            <div className="lg:w-[35%]" data-aos="flip-down">
