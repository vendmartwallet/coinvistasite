  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="mx-4 lg:w-[80%] bg-[#071332] text-black px-2 overflow-0 pt-[30px] rounded-lg">
            ...
            <div>
              <ul className="text-white">
                ...
                <ul>
                  ...
                  <li className="list-decimal">Visit www.moonpay.com;</li>
                  <li className="list-decimal">Click on buy Crypto</li>
                  <li className="list-decimal">Select the type of Crypto</li>
                  <li className="list-decimal">Enter and Continue</li>
                  <li className="list-decimal">
