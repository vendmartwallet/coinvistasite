      ...
      <div>
        <div className="tcChart lg:flex flex-col lg:flex-row items-center lg:min-h-[80vh] px-5 lg:px-20">
          <div className=" lg:w-[50%] text-center">
            <div
              className="title pb-5 text-3xl lg:text-4xl font-bold"
              data-aos="fade-down"
            >
              BITCON PRICE CHART
            </div>
          ...
          <div className=" lg:w-[50%] text-center">
            <div
              className="title py-5 text-3xl lg:text-4xl font-bold"
              data-aos="fade-right"
            >
              COMPANY INFORMATION
            </div>
            <div className=" mx-5 lg:mx-10 gap-6 lg:flex justify-center">
              <div
                className="cert lg:w-[70%] h-[60vh]"
                data-aos="fade-left"
              ></div>
              <div
                className="border-l-[15px] text-start pl-2 border-l-[#041E37] w-[60%] h-[35vh]"
                data-aos="fade-right"
              >
